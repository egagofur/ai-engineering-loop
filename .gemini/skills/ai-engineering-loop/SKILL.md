...
- `generate-workflow`: load skill `generate-workflow` if present. Grill Q1-Q5. Then write `.ai-engineering-loop/workflow.md` and empty `lessons.md` if missing. Do not start Maker.
