...
6. **Production runtime controls**: `REPORT_ONLY`, human-approved `ASSISTED`, opt-in `UNATTENDED`, actual token ledgers, lean/standard/thorough review profiles, a persistent kill switch, and locked disposable Maker worktrees.
