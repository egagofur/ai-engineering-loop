...
function workflowMarkdown({ hooks = DEFAULT_HOOKS, optionalSkips = [] } = {}) {
...
function writeWorkflowOverlay(rootDir, { hooks, optionalSkips } = {}) {
...
function formatGenerateWorkflowReport({ version, wrote } = {}) {
  const lines = [
    ...
    'Next: load skill generate-workflow. Ask Q1-Q5. Wait.',
