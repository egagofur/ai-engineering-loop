...
const REQUIRED_HOST_ASSETS = [
  ...
  '.grok/skills/backend-development/SKILL.md',
  '.grok/skills/emil-design-eng/SKILL.md',
  '.grok/skills/animate/SKILL.md',
  '.grok/skills/review-animations/SKILL.md',
  ...
  '.gemini/skills/emil-design-eng/SKILL.md',
  '.gemini/skills/animate/SKILL.md',
  '.gemini/skills/review-animations/SKILL.md',
...
function runDoctor(rootDir = path.join(__dirname, '..')) {
  ...
  const requiredPackageEntries = ['bin/', 'lib/', 'core/', 'policies/', 'recipes/', 'schemas/', 'evals/', 'studio/'];
